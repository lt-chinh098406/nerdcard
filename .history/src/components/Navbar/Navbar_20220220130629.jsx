    ...
    <nav className="flex items-center">
      ...
      <ul className="md:flex md:gap-10 ml-auto text-16 font-semibold">
        {openMenu && isMobile ? (
          ...
          <>
            <li className="hover:text-purple-500 cursor-pointer">Feature</li>
            <li className="hover:text-purple-500 cursor-pointer">Menu</li>
            <li className="hover:text-purple-500 cursor-pointer">Our Store</li>
